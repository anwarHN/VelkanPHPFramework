...
class actionsModel extends model{
	...
	function load(){
		...
		$this->select->addItem("2", "Prueba 2");
		...
		$this->forma=new form(array("id"=>"forma1","method"=>"post","function"=>"guardar","class"=>"form-horizontal"));
		$this->forma->addRule("required", "true", "textArea,text");
